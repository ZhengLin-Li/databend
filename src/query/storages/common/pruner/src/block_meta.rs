...
/// [`BlockInfo`] contains [`BlockMetaIndex`], [`BlockMeta`] and a flag indicating whether the block has an aggregating index.
pub type BlockInfo = (BlockMetaIndex, Arc<BlockMeta>, bool);
